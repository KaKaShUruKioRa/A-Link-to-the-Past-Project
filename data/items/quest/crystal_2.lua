...
function item:on_started()
  item:set_savegame_variable("possession_crystal_2")
...
local function sage_question(key_item_entity)
  ...
  local map = game:get_map()
  game:start_dialog("_treasure.quest/crystal_2.1",function(answer)
  if answer == 2 then
    game:start_dialog("misc.sage_end",function()
      ...
      sol.timer.start(1000,function()
        ...
        sol.timer.start(1000,function()
          ...
          hero:teleport("A Link to the Past/Dark World/Overworld/D7_great_swamp","dest_dungeon_D7_great_swamp_0","fade")
          end)
        end)
      end)
    else 
