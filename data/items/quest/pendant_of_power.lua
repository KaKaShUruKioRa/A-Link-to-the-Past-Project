...
function item:on_started()
  item:set_savegame_variable("possession_pendant_of_power")
...
function item:on_obtaining()
  ...
  sol.timer.start(10000,function() 
    game:start_dialog("_treasure.quest/pendant_of_power.1",function()
      local last_dialog
      if game:get_value("get_pendant_of_wisdom") then last_dialog = "misc.pendants_all" else last_dialog = "misc.pendants_only_one" end
      game:start_dialog(last_dialog, function()
        ...
        sol.timer.start(1000,function()
          ...
          sol.timer.start(1000,function()
            ...
            hero:teleport("A Link To The Past/Light World/Overworld/desert_of_mystery","dest_dungeon_desert_of_mystery_0","fade")
          end)
        end)
      end)
    end)  
