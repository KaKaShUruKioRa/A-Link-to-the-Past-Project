...
function item:on_started()
  item:set_savegame_variable("possession_pendant_of_courage")
...
function item:on_obtaining()
  ...
  sol.timer.start(10000,function() 
    game:start_dialog("_treasure.quest/pendant_of_courage.1",function()
      ...
      sol.timer.start(1000,function()
        ...
        sol.timer.start(1000,function()
          ...
          hero:teleport("A Link To The Past/Light World/Overworld/eastern_ruins","dest_dungeon_eastern_ruins_0","fade")
        end)
      end)
    end)  
  end)
