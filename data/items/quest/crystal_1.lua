...
local function sage_question(key_item_entity)
  ...
  local map = game:get_map()
  game:start_dialog("_treasure.quest/crystal_1.1",function(answer)
  if answer == 2 then
    game:start_dialog("misc.sage_end",function()
      ...
      sol.timer.start(1000,function()
        ...
        sol.timer.start(1000,function()
          ...
          hero:teleport("A Link to the Past/Dark World/Overworld/G4_dark_ruins","dest_dungeon_G4_dark_ruins_0","fade")
        end)
      end)
    end)
  else 
