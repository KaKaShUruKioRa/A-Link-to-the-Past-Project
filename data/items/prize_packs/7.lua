...
local probabilities = {
  ...
  [{ "consumables/rupee", 3 }]       = 12, -- 20 Rupees (12%)
  [{ "consumables/magic_jar", 2 }]   = 6,  -- Magic Jar 2 (6%)
  [{ "consumables/bomb_refill", 3 }] = 6,  -- 8 Bombs (6%)
  [{ "consumables/arrow_refill", 3 }]= 6,  -- 10 Arrows (6%)
  [{ "consumables/fairy", 1 }]       = 6,  -- Fairy (6%)
}
